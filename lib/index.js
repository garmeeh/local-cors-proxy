...
var startProxy = function(port, proxyUrl, proxyPartial, credentials, origin, exposedHeaders) {
  proxy.use(cors({credentials: credentials, origin: origin, exposedHeaders: exposedHeaders}));
  proxy.options('*', cors({credentials: credentials, origin: origin, exposedHeaders: exposedHeaders}));
