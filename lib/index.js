...
var startProxy = function(port, proxyUrl, proxyPartial, credentials, origin, noFollowRedirect) {
  ...
  proxy.use('/' + cleanProxyPartial, function(req, res) {
    ...
    req.pipe(
      request(cleanProxyUrl + req.url, {followRedirect : !noFollowRedirect})
  ...
  console.log(chalk.blue('Disable follow redirect: ' + chalk.green(noFollowRedirect) + '\n'));
  console.log(
    chalk.cyan(
