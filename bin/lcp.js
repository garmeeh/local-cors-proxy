...
var optionDefinitions = [
  ...
  { name: 'noFollowRedirect', type: Boolean, defaultValue: false }
];
...
try {
  ...
  lcp.startProxy(options.port, options.proxyUrl, options.proxyPartial, options.credentials, options.origin, options.noFollowRedirect);
} catch (error) {
  console.error(error);
}
